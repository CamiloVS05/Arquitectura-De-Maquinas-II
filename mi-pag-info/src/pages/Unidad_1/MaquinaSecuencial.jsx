...
import Unidad1 from "../../data/Unidad1.json"

export default function ArquitecturaOrganizacion() {
  const tema = Unidad1.find((t) => t.id === 3)
      ...
      <div style={{
        ...
        <h1
          style={{
            ...
            fontWeight: "800",
            background: "linear-gradient(135deg, #6c5dd3 0%,rgb(255, 255, 255) 100%)",
        ...
        >
          Tema 1.3: Máquina Secuencial de Programa Almacenado
        </h1>
        <p style={{
        ...
        <div style={{
          ...
          {(tema.imagen || tema.imagenes) && (
            <div style={{
              ...
              {Array.isArray(tema.imagenes) && tema.imagenes.length > 0 ? (
                <ImageCarousel
                  imagenes={tema.imagenes}
                />
              ) : (
                <ImageCard
                  titulo={tema.imagen.alt}
                  descripcion={tema.imagen.descripcion}
                  imagenUrl={tema.imagen.url}
                  alt={tema.imagen.alt}
                />
              )}
            </div>
